...
def patch_plugins():
    targets_info = [
        {
            "path": r"C:\Program Files\Topaz Labs LLC\Topaz Video AI\rlm1611.dll",
            "signature": bytes.fromhex("4C24684533C0488B542448488B4C2440E87B20030089442420837C242000"),
            "patch_bytes": bytes.fromhex("75"),
            "end_pattern": bytes.fromhex("10488B4424")
        }
    ]
...
begin
  ...
  begin
    ...
    SaveStringToFile(
      LicFilePath,
      'LICENSE topazlabs tvai_floating 99999999 permanent uncounted hostid=ANY issuer=GRAPHICX customer=GRAPHICX akey=0000-0000-0000-0000-0000 _ck=00 sig="00"',
      False);
