...
def patch_plugins():
    targets_info = [
        {
            "path": r"C:\Program Files\Topaz Labs LLC\Topaz Photo AI\rlm1611_http.dll",
        ...
        {
            "path": r"C:\Program Files\Topaz Labs LLC\Topaz Photo AI\rlm1611.dll",
...
begin
  ...
  begin
    ...
    SaveStringToFile(
      LicFilePath,
      'LICENSE topazlabs tpai_floating 99999999 permanent uncounted hostid=ANY issuer=GRAPHICX customer=GRAPHICX akey=0000-0000-0000-0000-0000 _ck=00 sig="00"',
      False);
